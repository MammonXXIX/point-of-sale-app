...
export const CreateOrderSheet = ({ open, onOpenChange }: CreateOrderSheetProps) => {
            ...
            <Sheet open={open} onOpenChange={onOpenChange}>
                <SheetContent className="w-full">
                    <SheetHeader>
                        ...
                        <SheetDescription>Add products to your cart and create a new order.</SheetDescription>
                    </SheetHeader>
                    ...
                    <div className="space-y-4 overflow-y-scroll p-4">
                        ...
                        <div className="flex flex-col gap-6">
                            {cartStore.items.map((item) => (
                                <OrderItem key={item.id} id={item.id} name={item.name} price={item.price} imageUrl={item.imageUrl} quantity={item.quantity} />
                            ))}
                        </div>
                    </div>
                    ...
                    <SheetFooter>
                        ...
                        <Button size="lg" className="mt-8 w-full" onClick={handleCreateOrder}>
                            Create Order
                        </Button>
                    </SheetFooter>
                </SheetContent>
