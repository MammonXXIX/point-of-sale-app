...
export const DashboardDescription = ({ children, className = '' }: DashboardDescriptionProps) => {
            ...
            <div className="flex h-screen w-full">
                <Sidebar>
                    ...
                    <SidebarContent className="overflow-x-hidden px-4">
                        <SidebarMenu>
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild tooltip="Create Order" isActive={router.pathname.includes('/dashboard')}>
                                    <Link href="/dashboard">
                        ...
                        <SidebarMenu>
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild tooltip="Category Management" isActive={router.pathname.includes('/categories')}>
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild tooltip="Product Management" isActive={router.pathname.includes('/products')}>
                                    <Link href="/products">
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild tooltip="Sales Dashboard" isActive={router.pathname.includes('/sales')}>
                                    <Link href="/sales">
